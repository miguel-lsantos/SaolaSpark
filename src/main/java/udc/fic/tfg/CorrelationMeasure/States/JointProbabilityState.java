...
public class JointProbabilityState
{
  ...
  public JointProbabilityState(double[] firstVector, double[] secondVector)
  {
    ...
    firstMaxVal = ArrayOperations.normaliseArray(firstVector,firstNormalisedVector);
    secondMaxVal = ArrayOperations.normaliseArray(secondVector,secondNormalisedVector);
